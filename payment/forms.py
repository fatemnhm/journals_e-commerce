...
class ShippingForm(forms.ModelForm):
	...
	shipping_state = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Governorate'}), required=False)
...
class PaymentForm(forms.Form):
    ...
    card_state = forms.CharField(
        label="", 
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Billing Governorate'}), 
        required=True
    )
